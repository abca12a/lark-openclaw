...
import type { LarkAccountConfig, LarkConfig, LarkTokenSource, ResolvedLarkAccount } from "./types.js";

function listConfiguredAccountIds(cfg: { channels?: { lark?: LarkConfig } }): string[] {
...
export function listLarkAccountIds(cfg: { channels?: { lark?: LarkConfig } }): string[] {
...
export function resolveDefaultLarkAccountId(cfg: { channels?: { lark?: LarkConfig } }): string {
...
function mergeLarkAccountConfig(
  cfg: { channels?: { lark?: LarkConfig } },
  accountId: string
): LarkAccountConfig {
...
function resolveCredentials(
  cfg: { channels?: { lark?: LarkConfig }; plugins?: unknown },
  merged: LarkAccountConfig
): { appId: string; appSecret: string; source: LarkTokenSource } {
  // From channel config
  ...
  // From plugin config
  const pluginCfg = cfg.plugins as { entries?: { lark?: { config?: LarkAccountConfig } } } | undefined;
...
export function listEnabledLarkAccounts(
  cfg: { channels?: { lark?: LarkConfig }; plugins?: unknown }
): ResolvedLarkAccount[] {
